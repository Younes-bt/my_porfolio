    ...
    <div className="space-y-10">
      ...
      <div className="relative pl-6 before:absolute before:left-2 before:top-0 before:h-full before:w-px before:bg-gradient-to-b before:from-emerald-400/60 before:to-transparent">
        {items.map((item, index) => (
          ...
          >
            <div className="absolute left-[-34px] top-6 flex h-4 w-4 items-center justify-center rounded-full border border-emerald-400 bg-white text-emerald-500 dark:border-emerald-300 dark:bg-slate-950">
              <div className="h-2.5 w-2.5 rounded-full bg-emerald-400 dark:bg-emerald-300" />
            </div>
            <Card className="border-slate-900/10 bg-white/80 text-slate-900 dark:border-white/10 dark:bg-slate-900/70 dark:text-white">
              <CardContent className="space-y-3 py-6">
                ...
                <h2 className="text-2xl font-display text-slate-900 dark:text-white">{item.title}</h2>
